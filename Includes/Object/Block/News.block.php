...
class News extends Block
{
    ...
    public function getAll()
    {
        return $this->db->query('
            SELECT deleted_id, topic_id, topic_url, topic_image, topic_views, topic_text, topic_name, topic_created, topic_posts, topic_locked, topic_sticked, ' . $this->select->user() . ', topic_sticked, user_last_activity
            FROM ' . TABLE_TOPICS . '
            ...
            WHERE f.forum_main = 1 AND t.deleted_id IS NULL AND fps.forum_id IS NOT NULL AND cps.category_id IS NOT NULL
