...
class Post extends \Page\Page
{
    ...
    protected function body()
    {
        ...
        // LIST
        $list = new Lists('/Report/Post');
        $list->object('post')->fill(data: $report->getAllPost(), function: function ( \Visualization\Admin\Lists\Lists $list ) { 
