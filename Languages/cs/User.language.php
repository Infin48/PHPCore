...
$language = array_merge($language, [
    ...
    'L_BAR_ABOUT' => 'O mně',
    'L_BAR_PROFILE' => 'Profilové nastavení',
    ...
    'L_USER_AGE' => 'Věk',
    'L_USER_GENDER' => 'Pohlaví',
    'L_USER_LOCATION' => 'Bydliště',
    ...
    'L_REGISTER_ALREADY' => 'Již máte účet ?',
    'L_REGISTER_BUTTON' => 'Registrovat se',
    'L_REGISTER_NOT' => 'Nemáte účet ?',
    'L_REGISTER_AGREE' => 'Kliknutím na <strong>Registrovat se</strong> souhlasíte s našimi smluvními podmínkami',
    'L_REGISTER_TERMS_TITLE' => 'Smlůvní podmínky',
    

    // LOGIN

    'L_LOGIN' => 'Přihlášení',
    'L_LOGIN_BUTTON' => 'Přihlásit se',
    'L_LOGIN_BUTTON_BACK' => 'Zpět na přihlášení',
    'L_LOGIN_REMEMBER' => 'Zůstat přihlášen',
    'L_FORGOT_PASSWORD' => 'Zapomenuté heslo',
    'L_FORGOT_PASSWORD_DESC' => 'Po stisknutí tlačítka odeslat vam bude odeslán potvrzovací e-mail s odzakem na změnu hesla',
    ...
    'L_PROFILE_MESSAGE_TO_PROFILE' => 'Napište něco...',
    'L_PROFILE_MESSAGE_TO_MY_PROFILE' => 'Aktualizujte váš stav...',

    'L_USER_ONLINE' => 'Online',
    'L_USER_LAST_LOGGED_IN' => 'Naposledy online',

    'L_INFORMATIONS' => 'Informace'
]);