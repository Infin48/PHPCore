...
$language['L_NAVBAR'] = [
    ...
    'L_ADMIN' => 'Admin',
    'L_PROFILE' => 'Profil',
    'L_LOG_OUT' => 'Odhlásit se',
    'L_USER_PANEL' => 'Uživatelský panel',


    // USER NOTIFICATIONS

    'L_NOTIFICATION_NO' => 'Žádná upozornění',
    'L_NOTIFICATION_EMPTY' => '<strong>Upozornění není k dispozici!</strong> Upozornění se zřejmě týká věci mimo rozsah vašeho oprávnění.',
    'L_NOTIFICATION_NAME' => 'Upozornění',
    'L_NOTIFICATION_SHOW_ALL' => 'Zobrazit vše',
